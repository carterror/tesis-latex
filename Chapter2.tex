...
\begin{effortestimation}
	\addentry[1]{Iniciar Sesión}{1}
	\addentry[1]{Gestión de Perfiles de Usuario}{1}
	\addentry[1]{Registrar Cita}{1}
	\addentry[1]{Autenticar Usuario}{1}
	\addentry[1]{Modificar Usuario}{1}
	\addentry[1]{Registrar Usuario}{1}
	\addentry[1]{Eliminar Usuario}{1}
	\addentry[2]{Notificar vía SMS}{1}
	\addentry[2]{Crear Contrato}{1}
	\addentry[2]{Modificar Contrato}{1}
	\addentry[2]{Eliminar Contrato}{1}
	\addentry[2]{Imprimir Contrato}{1}
	\addentry[3]{Crear Tramite}{1}
	\addentry[3]{Modificar Tramite}{1}
	\addentry[3]{Eliminar Tramite}{1}
	\addentry[3]{Crear Prefactura}{1}
	\addentry[3]{Modificar Prefactura}{1}
	\addentry[3]{Eliminar Prefactura}{1}
	\addentry[3]{Imprimir Prefactura}{1}
	\addentry[4]{Solicitar Cita al notario}{1}
	\addentry[4]{Aceptar Cita}{1}
